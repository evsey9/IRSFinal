...
function l_hand()
{
	...
	while(true)
		{
			print(brick.sensor("A2").read());
			if (brick.sensor("A1").read() > 30 && a1 > 30) {turnDirection(90, 40);}
			if (brick.sensor("A2").read() < 15 && a2 < 15) {turnDirection(-90, 40);}
			eht(20);
			l_hand(20)
			script.wait(10)
